...
class CNN_skipCo_trainer(object):
    ...
    def fit(self):
        ...
        scale_params_low, scale_params_high = utils.load_params(image_type=self.image_type, param_type="scale")
        mean_image_low, mean_image_high = utils.load_params(image_type=self.image_type, param_type="mean_image")
