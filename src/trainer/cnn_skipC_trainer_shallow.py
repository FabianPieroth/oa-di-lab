...
class CNN_skipCo_trainer(object):
    ...
    def fit(self, epochs=10):
        ...
        for e in range(0, epochs):
            ...
            self.dataset.batch_names(batch_size=16)
            ...
            for i in range(self.dataset.batch_number):
                ...
                self.model.train_model(input_tensor, target_tensor, valid_in=input_tensor_val, current_epoch=e)
